...
const FirstShoutout = () => {
    ...
    const [componentView, setComponentView] = useState<'shoutout' | 'signup'>('shoutout');
    ...
    const [fan, setFan] = useState<Fan>({firstName:'',
        surname:'',
         countryOfResidence:'',
    ...
    return (
        componentView === 'shoutout' ? <Shoutout
        ...
        <SignUp
                ...
                errors={errors} setConfirmPassword={setConfirmPassword} confirmPassword={confirmPassword}
        />
    );
};
