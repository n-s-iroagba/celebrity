import { type Optional, Model, type Sequelize, DataTypes } from "sequelize"
...
interface BookingAttributes {
  ...
  userId: number
  projectId: number
  bookedSlotStartTime?: Date
  bookedSlotEndTime?: Date
}
...
export class Booking extends Model<BookingAttributes, BookingCreationAttributes> implements BookingAttributes {
  ...
  public bookedSlotStartTime?: Date
  public bookedSlotEndTime?: Date
    ...
    Booking.init(
      {
        ...
        bookedSlotStartTime: { type: DataTypes.DATE, allowNull: true },
        bookedSlotEndTime: { type: DataTypes.DATE, allowNull: true },
      },
